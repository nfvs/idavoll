...
class Storage:
    ...
    # TODO: JID resource??
    def _setSubscriptionOptions(self, cursor, nodeIdentifier, subscriber,
                                options, subscriptionIdentifier=None,
                                sender=None):
...
class Node:
    ...
    def setAffiliation(self, entity, affiliation):
        return self.dbpool.runInteraction(self._setAffiliation, entity,
                                          affiliation)
    ...
    def _setAffiliation(self, cursor, entity, affiliation):
        ...
        if not row:
            cursor.execute("""INSERT INTO affiliations
                ...
                as e""", (affiliation, self.nodeIdentifier, jid))
        # update affiliation
        else:
            cursor.execute("""UPDATE affiliations SET affiliation=%s WHERE
                ...
                (affiliation, jid, self.nodeIdentifier))
